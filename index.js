...
class AccessibleSVG {
    constructor(config) {
        ...
        this.drawLine = (x1, y1, x2, y2, strokeWidth) => {
        ...
        this.text = (inputText, x, y, fontsize) => {
        ...
        this.doPath = (pathSequence, strikeWidth = 3) => {
        ...
        this.yAxisValues = (yAxis, maxValue, height, width, gap, fontSize) => {
        ...
        this.xAxisValue = (xAxis, height, gap, fontSize, distanceBetweenXPoints = null, maxValue = null, width = null) => {
            const g = this.createGTag(false);
